      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-10 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            />
            <p className="text-[#999] text-sm leading-relaxed max-w-xs mb-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-[#999] hover:text-[#25D366] transition-colors"
            >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="text-[#999] text-sm hover:text-[#C9A84C] transition-colors"
                  >
                    {l.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-5 text-sm text-[#999]">
              <div>
